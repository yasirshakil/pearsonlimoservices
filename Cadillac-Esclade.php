        ...
        <div class="row my-5">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center mb-5">
                <section class="template-title center">
                    <h1 class="title has-over">Cadillac Escalade</h1>
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12 py-4 pr-5">
                <h3 class="mb-2 limoColor">Cadillac Escalade:</h3>
                <p class="mb-2">
                    Pearson Limo Service offers luxury premium SUV and is able to fit 6-7 passengers, Cadillac has earned a
                    reputation for delivering total comfort and excellence. <b>
                    This special version of the Cadillac
                    Escalade SUV promises to be a favorite among VIPs, celebrities, politicians,
                    executives and anyone who values solid performance and executive style.
                    </b> Cadillac
                    Escalade Platinum limo service can be used for business and corporate events, wedding limo rentals and
                    airport limo transfer but can be used for need necessary. From airport transportation to all major public
                    and private airports. anniversaries and weddings, birthdays and bachelors, night on the town or simply
                    sight seeing tours. Each driver is fully screened, trained, licensed and dressed. Each vehicle is inspected,
                    cleaned and properly serviced to ensure the utmost safety for our passengers. Rates can vary from date,
                    time and location, and reservations can be made easily and quickly! Our system is up to date and you
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-12 Cars-Detail p-5 my-4">
                <h5 class="ml-2">Cadillac Escalade Details</h5>
                <p>
                <div class="About-Car">
