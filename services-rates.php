					...
					<div class="col-md-3">
						<div class="price-car center border bg-1">
							...
							<ul class="level-price">
								...
								<li>
									<div class="value">
										<span class="price">$400</span> / hour
									</div>
									<p class="Our-Services-Text">*Min 2 Hr Service + 13% HST</p>
								</li>
								<li>
								...
								<li>
									<div class="value">
										<span class="price">$150</span> / hour
									</div>
									<p class="Our-Services-Text">*Min 2 Hr Service + 13% HST</p>
								</li>
								<li>
									<div class="value">
										<span class="price">$125</span> / hour
									</div>
									<p class="Our-Services-Text">*Min 2 Hr Service + 13% HST</p>
								</li>
								<li>
									<div class="value">
										<span class="price">$170</span> / hour
									</div>
									<p class="Our-Services-Text">*Min 2 Hr Service + 13% HST</p>
								</li>
								<li>
									<div class="value">
										<span class="price">$175</span> / hour
									</div>
									<p class="Our-Services-Text">*Min 2 Hr Service + 13% HST</p>
								</li>
								<li>
									<div class="value">
										<span class="price">$275</span> / hour
									</div>
									<p class="Our-Services-Text">*Min 2 Hr Service + 13% HST</p>
								</li>
								<li>
			...
			<div class="limoking">
				...
				<p>If there is anything we haven’t covered, or if you have any special requirements please let us
					...
					volume, budget, or urgency. Please call us at any time of the day or night <a
						style="color: #d9c77e;" href="tel:+14373707407">+1 (437)-370-7407</a>.</p>
			</div>
		</div>
		<!-- End Services Ratea -->
