    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12 py-4 pr-5">
                ...
                <p class="mb-2">
                    Pearson Limo Service offers 30 Passengers Limo Party Bus is brand new and a perfect fit for
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-5">
                ...
                <hr>
                <h3 class="mb-2"><b>The Limo Bus Style Limousine comes fully equipped with:</b></h3>
                <ul class="listPoints mb-2">
                    <li>Room for Up to 40 Passengers – even standing up! (depending on the size of the passengers)</li>
