			...
			<div id="rev_slider_1078_2" class="rev_slider fullwidthabanner" style="display:none;"
				...
				<ul>
					...
					<li data-index="rs-3049" data-transition="slideremovedown" data-slotamount="7"
						...
						data-easeout="Power3.easeInOut" data-masterspeed="2000" data-rotate="0"
						data-saveperformance="off" data-title="Ken Burns" data-param1="" data-param2="" data-param3=""
						data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
						data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="https://www.luxorlimo.com/uploads/HPSlideModel/43/bgImage/fe17_699f_luxor-limo-professional-car-serviceslider.slider.jpg"
							alt="" data-bgposition="center center" data-kenburns="off" data-duration="30000"
						...
						<!-- LAYERS -->
						<div class="tp-caption title ff-2 color-white" id="slide-3049-layer-1"
							data-x="['center','center','center','center']" data-hoffset="['275','0','0','0']"
							data-y="['middle','middle','middle','middle']" data-voffset="['21','21','21','21']"
							data-fontsize="['60','40','30','26']" data-lineheight="['65','60','50','32']"
							data-fontweight="['400','400','400','400']" data-width="100%" data-color="#d9c77e"
							data-height="auto" data-type="text" data-whitespace="normal" data-responsive_offset="on"
					...
					<li data-index="rs-3050" data-transition="slideremovedown" data-slotamount="7"
						...
						data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="https://www.luxorlimo.com/uploads/HPSlideModel/44/bgImage/3585_wi-fi.slider.jpg"
							alt="" data-bgposition="center center" data-kenburns="off" data-duration="30000"
							data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0"
							data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10"
							class="rev-slidebg" data-no-retina>
			...
			<div id="tab-1" class="fleet-carousels">
				<div class="row">
					<div class="fleet-item col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="fleet-itme-inner">
							<div class="images fleet-img">
								<img class="FleetBox-img" src="images/cars/chryler-300.jpg" alt="">
							</div>
					...
					<div class="fleet-item col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="fleet-itme-inner">
							<div class="images fleet-img">
								<img class="FleetBox-img" src="images/cars/chevrolet-sub.jpg" alt="">
							</div>
							<div class="fleet-content fleet-details">
								<h4 class="fleet-title">
					...
					<div class="fleet-item col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="fleet-itme-inner">
							...
							<div class="fleet-content fleet-details">
								<h4 class="fleet-title">
									<a href="#">LINCOLN MKT STRETCH LIMOUSINE</a>
								</h4>
								<ul>
									<li class="author">
			...
			<div id="tab-3" class="fleet-carousels">
				<div class="row">
					...
					<div class="fleet-item col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="fleet-itme-inner">
							<div class="images fleet-img">
								<img class="FleetBox-img" src="images/cars/4.jpeg" alt="">
							</div>
							<div class="fleet-content fleet-details">
								<h4 class="fleet-title">
			...
			<div id="tab-4" class="fleet-carousels">
				<div class="row">
					...
					<div class="fleet-item col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="fleet-itme-inner">
							<div class="images fleet-img">
								<img class="FleetBox-img" src="images/cars/Black-Hummer-Limo-Up-to-16-passengers.jpg"
									alt="">
							</div>
							<div class="fleet-content fleet-details">
								<h4 class="fleet-title">
			...
			<div id="tab-5" class="fleet-carousels">
				<div class="row">
					...
					<div class="fleet-item col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="fleet-itme-inner">
							<div class="images fleet-img">
								<img class="FleetBox-img" src="images/cars/55.jpg" alt="">
							</div>
							<div class="fleet-content fleet-details">
								<h4 class="fleet-title">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-12 Col-Box">
					...
					<div class="Content-Box">
						...
						<p style="margin-bottom:48px;" class="bb-descr mt-3">
							...
							international and domestic airports of GTA. Call us at <a class="Highlight" href="tel:437-800-1547">437-800-1547</a> for your perfect ride to
							airport.
						</p>
						<div>
							<div class="LinksBox">
