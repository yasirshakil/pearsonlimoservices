	...
	<div class="layout-theme">
		...
		<section class="tp-banner has-tab">
			<div id="rev_slider_1078_2_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
				data-alias="classic4export" data-source="gallery"style="margin:0px auto;background-color:transparent;padding:0px;margin;">
							...
							<div id="bk-1" class="schedule-booking">
								<form class="form-booking" method="get" action="#">
									...
									<div class="btn-submit">
										<a href="#" class="register_now">Reserve Now<img
