    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 Cars-Detail-imgBox animate__animated animate__backInLeft">
                ...
                <h3 class="my-4 limoColor">Mercedes S550:</h3>
            </div>
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12 py-4">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-12 Cars-Detail p-5 my-4">
                <h5 class="ml-2">Mercedes S550 Details</h5>
                <p>
                <div class="About-Car">
                ...
                <div class="About-Car">
                    <i class=" fa fa-play mr-2" aria-hidden="true "></i> Flag Screen TVs, DVD Player CD Player with AM
                    <br> / FM and Splash Leather Seats
                </div>
