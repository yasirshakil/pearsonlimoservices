        ...
        <div class="container my-5 bgColor">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <h1 style="color:#d9c77e;" class="my-2 AjaxLimo">Airport Pickup Procedure</h1>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <p class="mb-2 AreaDetails">Clear Customs, pick up your checked-in bags if any, and walk through the
                    ...
                    <p class="my-2 AreaDetails">Clear Customs, pick up your checked-in bags if any, and walk through the
                        arrival hall, just as you step out of the arrival hall and come out to the terminal’s public
                        area you will see the doors with alphabets. You need to <b>look for Door A</b>. Now you
                        need to head to <b>POST 7</b>
                    </p>
                    <p class="mb-2 AreaDetails">
