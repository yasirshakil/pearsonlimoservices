		...
		<section class="services-area">
			<div class="container">
				...
				<p class="mb-4">
					...
					Looking to book a limo for the airport transfer. We are here to help with the best service and luxurious fleet. We have a dedicated fleet for airport transfers which covers all international and domestic airports of GTA. Call us at <a style="color: #d9c77e;"
						href="tel:+1905-974-9873">905-974-9873</a> for your perfect ride to airport
				</p>
				<div class="row">
					...
					<div class="col-lg-3 col-md-3 col-sm-6">
						<div class="services-item center">
							...
							<div class="services-content">
								<h4><a class="Golden" href="Corporate-Limo-Services.php">Corporate Limo Service</a></h4>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6">
						<div class="services-item center">
							...
							<div class="services-content">
								<h4><a class="Golden" href="Wedding-Limo-Services.php">Wedding Limo Rentals</a></h4>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6">
					...
					<div class="col-lg-3 col-md-3 col-sm-6">
						<div class="services-item center">
							...
							<div class="services-content">
								<h4><a class="Golden" href="Funeral-Limousine-Services.php"> Funeral Limo Service</a></h4>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6">
						<div class="services-item center">
							...
							<div class="services-content">
								<h4><a class="Golden" href="Medical-Limo-Transfer.php"> Non-Emergency Medical Limo Transfer   </a></h4>
							</div>
						</div>
					</div>
				</div>
