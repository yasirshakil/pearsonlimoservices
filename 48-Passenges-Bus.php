    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12 py-4 pr-5">
                ...
                <p class="mb-2">
                    Pearson Limo Service offers 48 Passengers Limo Party Bus is brand new and a perfect fit for
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-5">
                ...
                <ul class="listPoints mb-2">
                    <li>Room for Up to 48 Passengers – even standing up! (depending on the size of the passengers)</li>
